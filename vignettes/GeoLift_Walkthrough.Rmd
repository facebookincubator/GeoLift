...
We will do this by running the `GeoLiftPower` method and expanding our `lookback_window` to 10 days, only for these two treatment combinations and plot their results.
